...
Kobra-3 (and ACM) has now been replaced against a Creality K2 Plus (with ACM) and donated to Ukraine. My older Anycubic devices (like, Vyper) also found new owners, and I'm happy to report now that this shop has been converted to an Anycubic free zone.
