...
Most recent addition to my printer park is a [Sovol SV08](https://github.com/Bushmills/Sovol-SV08) - again, rather open firmware:  apparently Armbian, with Klipper, ssh login (user: sovol, passwd: sovol), sudo for root, and stuff preinstalled not unlike the KLP1. Debian package management works out of the box.
Kobra-3 (and ACM) has now been replaced against a Creality K2 Plus (with ACM). I may donate it to Ukraine. My older Anycubic devices (like, Vyper) also found new owners, and I'm happy to report now that this shop has been converted to an Anycubic free zone.
