...
Creality K2 Plus (with ACM) has replaced the Anycubic Kobra-3 (and ACM). Rootable by checkbox from user dialog. But less RAM, less powerful SOC. While still running Linux, the preinstalled Linux, a customized Lede/OpenWRT, is more dedicated to 3D printer operations, and lacks package management tools such as opkg. It too runs with Klipper and the fluidd frontend.
